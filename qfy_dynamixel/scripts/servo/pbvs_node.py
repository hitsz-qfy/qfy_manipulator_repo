...
class Pbvs(object):
    ...
    def pub_error(self):
        ...
        self.pbvs_error.tc_o.x = self.tracker.get_tc_o_mat().item(0)
        self.pbvs_error.tc_o.y = self.tracker.get_tc_o_mat().item(1)
        self.pbvs_error.tc_o.z = self.tracker.get_tc_o_mat().item(2)

        self.pbvs_error.tcstar_o.x = self.tracker.get_tcstar_o_mat().item(0)
        self.pbvs_error.tcstar_o.y = self.tracker.get_tcstar_o_mat().item(1)
        self.pbvs_error.tcstar_o.z = self.tracker.get_tcstar_o_mat().item(2)
