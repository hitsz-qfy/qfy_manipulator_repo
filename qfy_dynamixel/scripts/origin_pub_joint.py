...
#     pub_mjp.data = [1.57, 0.0, -1.3, 0.0, 0.0, 0.0, -0.6]
    ...
    change_value = [-0.0026, 0.4526, 0.500, 0.003, 0.9529, 0.0554, 0.0]
    origin_value = [1.57, 1.0, 0.5, 0.0, 0.4, 0.0, 0.0]

    pub_mjp.data = list(origin_value[i] - change_value[i]*0.3 for i in xrange(7))
